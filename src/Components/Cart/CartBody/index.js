    ...
    return (
        ...
        <table>
            ...
            {props.products.map((product,index)=>
                ...
                <td>{product.name}</td>
                <td>{product.price}</td>
                <td><span>{props.quantity[index]}</span><div id='quantity-icons-holdr'><i className='fas fa-arrow-alt-circle-up up-arrow' onClick={(e)=>props.handleClick(index,e)}></i><i className='fas fa-arrow-alt-circle-down down-arrow' onClick={(e)=>props.handleClick(index,e)}></i></div></td>
                <td>{props.total_price[index].toFixed(2)}$</td>
                </tr>
                <hr/>
                </>
